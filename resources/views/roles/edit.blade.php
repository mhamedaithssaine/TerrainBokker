...
@section('content')
    <h1 class="text-2xl font-semibold text-gray-800 mb-6">Modifier le Rôle</h1>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <form action="{{ route('roles.update', $role->id) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name" id="name" value="{{ $role->name }}" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm" required>
                @error('name')
