...
<head>
    ...
    <title>404 - Page Non Trouvée - TerrainBooker</title>
...
@keyframes flicker4{
  0%  {color: #046404;text-shadow:0px 0px 4px #046404;}
  30% {color: #ff005d;text-shadow:0px 0px 4px #046404;}
  31% {color: #12000a;text-shadow:0px 0px 4px #12000a;}
  32% {color: #ff005d;text-shadow:0px 0px 4px #046404;}
  36% {color: #ff005d;text-shadow:0px 0px 4px #046404;}
  37% {color: #12000a;text-shadow:0px 0px 4px #12000a;}
  41% {color: #12000a;text-shadow:0px 0px 4px #12000a;}
  42% {color: #046404;text-shadow:0px 0px 4px #046404;}
  85% {color: #046404;text-shadow:0px 0px 4px #046404;}
  86% {color: #12000a;text-shadow:0px 0px 4px #12000a;}
  95% {color: #12000a;text-shadow:0px 0px 4px #12000a;}
  96% {color: #046404;text-shadow:0px 0px 4px #046404;}
  100%{color: #046404;text-shadow:0px 0px 4px #046404;}
}

@keyframes fadeInText{
  1%  {color: #12000a;text-shadow:0px 0px 4px #12000a;}
  70% {color: #046404;text-shadow:0px 0px 14px #046404;}
  100%{color: #046404;text-shadow:0px 0px 4px #046404;}
}
...
<body class="bg-gray-900 min-h-screen flex items-center justify-center p-4 overflow-hidden">
    ...
    <h2>Page Not Found 
      <br>
      <a style="text-decoration:none; color:#36ff68; font-size: 1rem;" href="{{url()->previous()}}">Retour</a>
    </h2>
